...
public class MenuPersonalizacao
{
    ...
    private void DesenharNavePreview(SpriteBatch spriteBatch, Vector2 posicao, Color corPrincipal, Color corDetalhes)
    {
        ...
        switch (_personalizacao.ModeloNave)
        {
            case Game.PersonalizacaoJogador.TipoNave.Triangular:
                DesenharTrianguloPreview(spriteBatch, new Vector2(x, y), corPrincipal);
                break;
            case Game.PersonalizacaoJogador.TipoNave.Losango:
                DesenharLosangoPreview(spriteBatch, new Vector2(x, y), corPrincipal);
                break;
            case Game.PersonalizacaoJogador.TipoNave.Hexagonal:
                DesenharHexagonoPreview(spriteBatch, new Vector2(x, y), corPrincipal);
                break;
            case Game.PersonalizacaoJogador.TipoNave.Circular:
                DesenharCirculoPreview(spriteBatch, new Vector2(x, y), corPrincipal);
                break;
        }
    }

    private void DesenharTrianguloPreview(SpriteBatch spriteBatch, Vector2 posicao, Color cor)
    {
        int x = (int)posicao.X;
        int y = (int)posicao.Y;
        
        var rect1 = new Rectangle(x - 4, y - 6, 8, 2);
        var rect2 = new Rectangle(x - 3, y - 4, 6, 2);
        var rect3 = new Rectangle(x - 2, y - 2, 4, 2);
        var rect4 = new Rectangle(x - 1, y, 2, 2);
        
        spriteBatch.Draw(_pixelTexture, rect1, cor);
        spriteBatch.Draw(_pixelTexture, rect2, cor);
        spriteBatch.Draw(_pixelTexture, rect3, cor);
        spriteBatch.Draw(_pixelTexture, rect4, cor);
    }

    private void DesenharLosangoPreview(SpriteBatch spriteBatch, Vector2 posicao, Color cor)
    {
        int x = (int)posicao.X;
        int y = (int)posicao.Y;
        
        var rect1 = new Rectangle(x - 1, y - 6, 2, 2);
        var rect2 = new Rectangle(x - 2, y - 4, 4, 2);
        var rect3 = new Rectangle(x - 3, y - 2, 6, 2);
        var rect4 = new Rectangle(x - 2, y, 4, 2);
        var rect5 = new Rectangle(x - 1, y + 2, 2, 2);
        
        spriteBatch.Draw(_pixelTexture, rect1, cor);
        spriteBatch.Draw(_pixelTexture, rect2, cor);
        spriteBatch.Draw(_pixelTexture, rect3, cor);
        spriteBatch.Draw(_pixelTexture, rect4, cor);
        spriteBatch.Draw(_pixelTexture, rect5, cor);
    }

    private void DesenharHexagonoPreview(SpriteBatch spriteBatch, Vector2 posicao, Color cor)
    {
        int x = (int)posicao.X;
        int y = (int)posicao.Y;
        
        var rect1 = new Rectangle(x - 2, y - 6, 4, 2);
        var rect2 = new Rectangle(x - 3, y - 4, 6, 2);
        var rect3 = new Rectangle(x - 3, y - 2, 6, 2);
        var rect4 = new Rectangle(x - 3, y, 6, 2);
        var rect5 = new Rectangle(x - 2, y + 2, 4, 2);
    ...
    private void DesenharCirculoPreview(SpriteBatch spriteBatch, Vector2 posicao, Color cor)
    {
        int x = (int)posicao.X;
        int y = (int)posicao.Y;
        
        var rect1 = new Rectangle(x - 2, y - 4, 4, 2);
        var rect2 = new Rectangle(x - 3, y - 2, 6, 2);
        var rect3 = new Rectangle(x - 3, y, 6, 2);
        var rect4 = new Rectangle(x - 2, y + 2, 4, 2);
